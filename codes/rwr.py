...
def formart_DISandRNA(RNA_CIS, Disease_DIS):
    ...
    np.save('../dataset/rwr/RWR_FORMART_DIS.npy', DIS)
    np.save('../dataset/rwr/RWR_FORMART_CIS.npy', RNA)
    return DIS, RNA
...
def SimtoRWR(RNA_CIS, Disease_DIS, FLAGS):
    ...
    path_DIS = '../dataset/rwr/RWR_FORMART_DIS.npy'
    path_CIS = '../dataset/rwr/RWR_FORMART_CIS.npy'
